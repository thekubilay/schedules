<template>
    <table class="schedule-table table-two" v-if="get_setting_load == 2" :style="{border:'2px solid #'+get_settings[0].line_color}">
        <thead>
            <tr>
        ...
        <tbody>
            <app-schedule-items v-for="(schedule, index) in schedules.table_two" :key="index" :schedule="schedule"/>
        </tbody>
    </table>
</template>
<script>
import appScheduleItems from './tb-two-items'
